...
def build_sampling_strategy(
    ...
    """Match your notebook: oversample classes whose count/majority < threshold to target_fraction*majority."""
...
def ctgan_oversample_to_global_majority(
    ...
    This follows your stated design choice in the manuscript and notebook:
    oversample minority classes to a target size derived from the global majority after cleaning.
    """
    if CTGAN is None:
    ...
    # ctgan expects column names list (newer versions) or indices (older). We'll use names.
